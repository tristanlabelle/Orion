...
namespace Orion.Game.Simulation
{
    ...
    public sealed class Terrain
    {
        ...
        #region Methods
        /// <summary>
        /// Creates a new terrain of a given size that has no obstacles.
        /// </summary>
        /// <param name="size">The size of the terrain to be created.</param>
        /// <returns>A newly created fully walkable terrain.</returns>
        public static Terrain CreateFullyWalkable(Size size)
        {
