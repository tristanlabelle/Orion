...
namespace Orion.Game.Simulation.Components
{
    public class Transport : Component
    {
        ...
        public static readonly EntityStat EmbarkSpeedStat = new EntityStat(typeof(Transport), "EmbarkSpeed", "Vitesse d'embarquement");
        public static readonly EntityStat DisembarkSpeedStat = new EntityStat(typeof(Transport), "DisembarkSpeed", "Vitesse de débarquement");
