...
namespace Orion.GameLogic.Tasks
{
    ...
    /// </summary>
    [Serializable]
    public sealed class WalkTask : MoveTask
    {
        #region Fields
        ...
        /// </param>
        public WalkTask(Unit unit, Func<Point, float> destinationDistanceEvaluator)
            : base(unit)
        {
        ...
        public WalkTask(Unit unit, Point destination)
        ...
        private PathWalker GetPathWalker()
        {
            ...
            if (path.Source == path.Destination && !path.IsComplete) return null;
