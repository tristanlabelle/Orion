...
{
    public class FuckedUpDropdownList<T> : Panel
    {
        #region Nested Types
        private sealed class DropdownMenuRow : View
        {
            #region Fields
            private readonly FuckedUpDropdownList<T> parent;
            ...
            public DropdownMenuRow(FuckedUpDropdownList<T> parent, T element)
                : base(parent.Bounds)
            {
                this.parent = parent;
                Value = element;
            ...
            #region Properties
            public new FuckedUpDropdownList<T> Parent
            {
                get { return parent; }
            }
            #endregion
        ...
        #region Constructors
        public FuckedUpDropdownList(Rectangle frame)
            : base(frame)
        {
        ...
        #region Events
        public event Action<FuckedUpDropdownList<T>, T> SelectionChanged;
        #endregion
